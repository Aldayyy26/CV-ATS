    ...
    <div class="container">
        ...
        <form>
            ...
            <div class="form-group">
                ...
                <div class="jenis">
                    <label>
                        <input type="radio" name="jenis" value="formal"> Formal
                    </label>
                    <label>
                        <input type="radio" name="jenis" value="nonformal"> Nonformal
                    </label>
                </div>
            </div>
            <div class="form-group">
                <label for="deskripsi">Ringkasan tentang pekerjaan anda Anda:</label>
